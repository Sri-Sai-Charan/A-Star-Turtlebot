...
class RRT():
    ...
    def __init__(self, start, goal, obstacleList,
                 randArea, expandDis=5.0, goalSampleRate=15, maxNodes=200, maxIter=10000):
        """
        Setting Parameter
    ...
    def Planning(self, animation=True):
        ...
        while i<self.maxIter:
            ...
            if self.__CollisionCheck(newNode, self.obstacleList): # if it does not collide
                ...
                ## previously: i+100
                self.nodeList[i] = newNode # add newNode to nodeList
                 ## previously: i+100
                self.rewire(i, newNode, nearinds) # make newNode a parent of another node if necessary
    ...
    def rewire(self, newNodeInd, newNode, nearinds):
        ...
        for i in nearinds:
            ...
            ## then rewire nearNode parent to be newNodeInd, basically now nearNode will be reached
            ## from newNode
